...
import Quiz1Intro from "./pages/Quiz/Quiz1/save/quiz1Intro";
import QuizLab from "./pages/Quiz/Quiz1/save/quiz1Lab";
import Quiz1Call from "./pages/Quiz/Quiz1/save/quiz1call";
import Quiz1FishV from "./pages/Quiz/Quiz1/save/quiz1fishV";
import Quiz1FishV2 from "./pages/Quiz/Quiz1/save/quiz1fishV2";
import Quiz1FishV3 from "./pages/Quiz/Quiz1/save/quiz1fishV3";
import Quiz1FishV4 from "./pages/Quiz/Quiz1/save/quiz1fishV4";
...
function App() {
  return (
    <Routes>
      ...
      <Route path="/quiz1/fishv4" element={<Quiz1FishV4 />} />
